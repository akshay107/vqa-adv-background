...
from models_clevr_adv.nmn3_netgen_att import AttentionSeq2Seq
from models_clevr_adv.nmn3_modules import Modules
from models_clevr_adv.nmn3_assembler import INVALID_EXPR
from models_clevr_adv.vgg_net import vgg_pool5
from util.cnn import fc_layer as fc, conv_layer as conv

class NMN3Model:
    def __init__(self, image_batch, masking_batch, grad_scaling_batch, text_seq_batch, seq_length_batch,
        ...
        with tf.variable_scope(scope, reuse=reuse):
            ...
            with tf.variable_scope('image_feature_cnn'):
                vgg = vgg_pool5(image_batch,masking_batch, grad_scaling_batch)
                image_feat_grid = vgg.image_feat_grid
                self.W_adv3 = vgg.W_adv3
                self.adv_input = vgg.adv_input
