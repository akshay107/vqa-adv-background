...
class BatchLoaderClevr:
    ...
    def load_one_batch(self, sample_ids):
        ...
        if self.load_answer:
            ...
            actual_answer_label_batch = np.zeros(actual_batch_size, np.int32)
        if self.load_gt_layout:
        ...
        for n in range(len(sample_ids)):
            ...
            if self.load_answer:
                ...
                actual_answer_idx = self.answer_dict.word2idx(iminfo['actual_answer'])
                actual_answer_label_batch[n] = actual_answer_idx
            if self.load_gt_layout:
        ...
        if self.load_answer:
            ...
            batch['actual_answer_label_batch'] = actual_answer_label_batch
        if self.load_gt_layout:
